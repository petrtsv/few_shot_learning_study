...
def save_as_tensors(source=os.path.join(DEFAULT_TACO_DIR, 'images'), target=os.path.join(DEFAULT_TACO_DIR, 'tensors'),
                    image_size=84):
...
def remove_small(threshold, root=os.path.join(DEFAULT_TACO_DIR, 'tensors')):
